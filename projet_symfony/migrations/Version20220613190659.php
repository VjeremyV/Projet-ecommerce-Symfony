 ...
 */
final class Version20220613190659 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE utilisateurs (id INT AUTO_INCREMENT NOT NULL, client_id INT DEFAULT NULL, pseudo VARCHAR(255) CHARACTER SET utf8 NOT NULL COLLATE `utf8_general_ci`, mot_de_passe VARCHAR(255) CHARACTER SET utf8 NOT NULL COLLATE `utf8_general_ci`, role VARCHAR(255) CHARACTER SET utf8 NOT NULL COLLATE `utf8_general_ci`, UNIQUE INDEX UNIQ_497B315E19EB6921 (client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_general_ci` ENGINE = InnoDB COMMENT = \'\' ');
